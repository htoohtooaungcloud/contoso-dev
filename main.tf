...
#Creating 6Subnets, 3Private, 3public
...
resource "aws_autoscaling_group" "auto_scaling_group_v1" {
  ...
  launch_template {
    id      = aws_launch_template.launch_template_meow_new.id
    version = aws_launch_template.launch_template_meow_new.latest_version
  }
}
...
resource "aws_launch_template" "launch_template_meow_new" {
